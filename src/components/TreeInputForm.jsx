...
return (
  <div className="px-8 my-8 lg:my-16">
    <div className='flex flex-col lg:flex-row justify-around items-center w-full my-8 lg:my-16'> {/* Adjusted for standard spacing */}
      {/* Tree Model Display */}
    ...
    <form onSubmit={handleSubmit} className="flex flex-col space-y-2 items-center mb-16">
      <input
        ...
        className="custom-input mb-8 lg:mb-16 w-full" // Standard margin-bottom, no md variant required here
      />
